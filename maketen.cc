...
double calc(double c1, double c2, int op) {
  switch (op) {
  case O_PLUS:
    return (c1 + c2);
    break;
...
std::string sc(int c1, int c2, int op) {
  std::stringstream s;
  s << c1 << s_op[op] << c2;
  return s.str();
}

std::string sc(std::string s1, std::string s2, int op) {
  std::stringstream s;
  s << "(" << s1 << ")" << s_op[op] << "(" << s2 << ")";
  return s.str();
}

std::string sc(int c1, std::string s2, int op) {
  std::stringstream s;
  s << c1 << s_op[op] << "(" << s2 << ")";
  return s.str();
}

std::string sc(std::string s1, int c2, int op) {
  std::stringstream s;
  s << "(" << s1 << ")" << s_op[op] << c2;
  return s.str();
}

double calc(int c1, int c2, int op) {
  return calc((double)c1, (double)c2, op);
}

double calc(double c1, int c2, int op) {
  return calc((double)c1, (double)c2, op);
}

double calc(int c1, double c2, int op) {
  return calc((double)c1, (double)c2, op);
}

void checkten1(int c1, int c2, int c3, int c4,
...
void checkten2(int c1, int c2, int c3, int c4,
               int op1, int op2, int op3) {
...
void checkten3(int c1, int c2, int c3, int c4,
               int op1, int op2, int op3) {
...
void checkten4(int c1, int c2, int c3, int c4,
               int op1, int op2, int op3) {
...
void checkten5(int c1, int c2, int c3, int c4,
               int op1, int op2, int op3) {
